...
class Divide_By_Two_Slider_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        $randomOrder = ! empty( $instance['randomOrder'] ) ? (bool) $instance['randomOrder'] : false;
        ?>
        <p>
        ...
        <div class="dbt-slider-settings" style="display:none; border:1px solid #ddd; padding:10px; margin-bottom:10px;">
            <fieldset>
                ...
                <p><input type="checkbox" name="<?php echo $this->get_field_name( 'randomOrder' ); ?>" <?php checked( $randomOrder ); ?>> <?php _e( 'Random Order', 'divide-by-two-slider' ); ?></p>
                ...
                <p><input type="checkbox" name="<?php echo $this->get_field_name( 'wrapAround' ); ?>" <?php checked( $wrapAround ); ?>> <?php _e( 'Wrap Around (Loop)', 'divide-by-two-slider' ); ?></p>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['randomOrder'] = ! empty( $new_instance['randomOrder'] );
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $instance['slides'] ) && is_array( $instance['slides'] ) ) {
            $slider_settings = [
                ...
                'randomOrder'         => ! empty( $instance['randomOrder'] ),
            ];
